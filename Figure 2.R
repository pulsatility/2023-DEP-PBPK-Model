# Comparison of PBPK model simulations with experimental data of Weschler et al. (2015): 250 ug/m^3 exposed for 6 hours body top exposed to air.
...
##### -------------Figure 2A-2B: To simulate Weschler hood -------------- ##### 
...
# Plot Figure 2B - plasma DEP/plasma MEP
...
##### -------------Figure 2C-2D: To simulate Weschler no hood -------------- ##### 
...
# Plot Figure 2D - plasma DEP/plasma MEP
